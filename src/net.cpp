...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Romancecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"romancecoin.org", "dnsseed.romancecoin.org"},
    {"romancecoin.com", "192.168.0.13"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Romancecoin is probably already running."), addrBind.ToString().c_str());
        else
