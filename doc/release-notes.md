...
- If you are running v0.8.7.4 as distributed by romancecoin.org you do not need to upgrade.
  The binaries distributed on romancecoin.org contain their own copy of openssl so they are unaffected by this issue.
